...
public class FormLogin extends javax.swing.JFrame {
    ...
    private void jButtonEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEntrarActionPerformed
        ...
        if(jTextFieldUser.getText().equals("admin")&&jPasswordFieldPassword.getText().equals("123")){
...
//        try {
//            liga.executaSql("select * from utilizador where username='"+jTextFieldUser.getText()+"'");
//            liga.rs.first();
//
//             if(liga.rs.getString("senha").equals(jPasswordFieldPassword.getText())){
//
